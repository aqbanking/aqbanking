...
PickStartDate::PickStartDate(const QDate &firstPossible,
                             const QDate &lastUpdate,
                             int defaultChoice,
                             QWidget* parent, const char* name,
                             bool modal, WFlags fl)
:PickStartDateUi(parent, name, modal, fl)
...
void PickStartDate::slotNoDateToggled(bool on){
}



void PickStartDate::slotLastUpdateToggled(bool on){
}



void PickStartDate::slotFirstDateToggled(bool on){
}



void PickStartDate::slotPickDateToggled(bool on){
