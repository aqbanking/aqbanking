...
AH_JOB *AH_Job_SepaCor1DebitDatedMultiCreate_new(AB_USER *u, AB_ACCOUNT *account) {
  ...
  AH_Job_TransferBase_SetExchangeParamsFn(j, AH_Job_SepaCor1DebitDatedMultiCreate_ExchangeParams);
...
/* --------------------------------------------------------------- FUNCTION */
int AH_Job_SepaCor1DebitDatedMultiCreate_ExchangeParams(AH_JOB *j, AB_JOB *bj,
