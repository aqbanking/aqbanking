...
static
GWEN_CRYPT_KEY * AH_MsgRhd7__VerifyInitialSignKey7(GWEN_CRYPT_TOKEN *ct,const GWEN_CRYPT_TOKEN_CONTEXT *ctx,AB_USER *user, GWEN_DB_NODE *gr)
{
...
int AH_Msg_EncryptRdh7(AH_MSG *hmsg) {
	...
	if (1) {
		...
		GWEN_Buffer_InsertBytes(skbuf,
				(const char *) GWEN_Crypt_KeyDes3K_GetKeyDataPtr(sk), 16);
