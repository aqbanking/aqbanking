...
static int AH_Job_SepaDebitDatedMultiCreate_ExchangeArgs(AH_JOB *j, AB_JOB *bj,
                                                         AB_IMEXPORTER_CONTEXT *ctx);
static int AH_Job_SepaDebitDatedMultiCreate_ExchangeResults(AH_JOB *j, AB_JOB *bj,
                                                            AB_IMEXPORTER_CONTEXT *ctx);

static int AH_Job_SepaDebitDatedMultiCreate_Exchange(AH_JOB *j, AB_JOB *bj,
                                                     AH_JOB_EXCHANGE_MODE m,
                                                     AB_IMEXPORTER_CONTEXT *ctx);

static int AH_Job_SepaDebitDatedMultiCreate_Process(AH_JOB *j, AB_IMEXPORTER_CONTEXT *ctx);
