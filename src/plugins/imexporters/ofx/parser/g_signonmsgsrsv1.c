...
AIO_OFX_GROUP *AIO_OfxGroup_SIGNONMSGSRSV1_new(const char *groupName,
  ...
  AIO_OfxGroup_SetStartTagFn(g, AIO_OfxGroup_SIGNONMSGSRSV1_StartTag);
...
int AIO_OfxGroup_SIGNONMSGSRSV1_StartTag(AIO_OFX_GROUP *g,
  ...
  if (strcasecmp(tagName, "SONRS")==0) {
    gNew=AIO_OfxGroup_SONRS_new(tagName, g, ctx);
  }
  else {
