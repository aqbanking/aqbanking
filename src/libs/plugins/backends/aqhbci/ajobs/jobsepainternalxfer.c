...
#include "jobsepainternalxfer_p.h"
...
/* --------------------------------------------------------------- FUNCTION */
AH_JOB *AH_Job_SepaInternalTransfer_new(AB_PROVIDER *pro, AB_USER *u, AB_ACCOUNT *account)
{
  AH_JOB *j;

  j=AH_Job_TransferBase_new("JobSepaInternalTransfer",
  ...
  AH_Job_SetSupportedCommand(j, AB_Transaction_CommandSepaInternalTransfer);

  /* overwrite some virtual functions */
  AH_Job_SetPrepareFn(j, AH_Job_SepaInternalTransfer_Prepare);
  AH_Job_SetAddChallengeParamsFn(j, AH_Job_SepaInternalTransfer_AddChallengeParams);
...
/* --------------------------------------------------------------- FUNCTION */
int AH_Job_SepaInternalTransfer_AddChallengeParams(AH_JOB *j, int hkTanVer, GWEN_DB_NODE *dbMethod)
{
...
/* --------------------------------------------------------------- FUNCTION */
int AH_Job_SepaInternalTransfer_Prepare(AH_JOB *j)
{
  int rv;
