...
int mkPinList(AB_PROVIDER *pro,
  ...
  GWEN_SyncIo_WriteLine(sio, "# This is a PIN file to be used with AqBanking");
  GWEN_SyncIo_WriteLine(sio, "# Please insert the PINs/passwords for the users below");
