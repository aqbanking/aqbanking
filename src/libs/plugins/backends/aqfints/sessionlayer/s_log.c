                                ...
                                int crypt)
{
  ...
  _setCharValue(db, GWEN_DB_FLAGS_OVERWRITE_VARS, "mode", AQFINTS_Session_GetSecProfileCode(sess));
  GWEN_DB_SetIntValue(db, GWEN_DB_FLAGS_OVERWRITE_VARS, "mversion", AQFINTS_Session_GetSecProfileVersion(sess));
