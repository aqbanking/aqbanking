...
#include "jobdeletedatedtransfer_be.h"
...
AB_JOB *AB_JobDeleteDatedTransfer_new(AB_ACCOUNT *a){
  return AB_JobTransferBase_new(AB_Job_TypeDeleteDatedTransfer, a);
}
...
int AB_JobDeleteDatedTransfer_SetTransaction(AB_JOB *j, const AB_TRANSACTION *t){
