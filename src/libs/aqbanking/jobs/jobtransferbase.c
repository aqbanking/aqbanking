...
int AB_JobTransferBase_GetMaxPurposeLines(const AB_JOB *j){
  ...
  DBG_ERROR(AQBANKING_LOGDOMAIN,
            "AB_JobTransferBase_GetMaxPurposeLines is deprecated");
...
void AB_JobTransferBase_SetMaxPurposeLines(AB_JOB *j, int i){
  DBG_ERROR(AQBANKING_LOGDOMAIN,
            "AB_JobTransferBase_SetMaxPurposeLines is deprecated");
}
