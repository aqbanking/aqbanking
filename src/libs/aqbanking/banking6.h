 ...
 */
AQBANKING_API int AB_Banking6_GetAccountSpecList(AB_BANKING *ab, AB_ACCOUNT_SPEC_LIST** pAccountSpecList);
 ...
 */
AQBANKING_API int AB_Banking6_GetAccountSpecByUniqueId(AB_BANKING *ab, uint32_t uniqueAccountId, AB_ACCOUNT_SPEC** pAccountSpec);
 ...
 */
AQBANKING_API int AB_Banking6_SendCommands(AB_BANKING *ab,
