...
static
int dblistTransfers(AB_BANKING *ab,
		    GWEN_DB_NODE *dbArgs,
		    int argc,
		    char **argv) {
  GWEN_DB_NODE *db;
  ...
  const GWEN_ARGS args[]={
  {
    ...
    "q",                            /* short option */
    "query",                    /* long option */
    "Specify the transfers to export",   /* short description */
    "Specify the transfers to export"      /* long description */
  },
  {
    GWEN_ARGS_FLAGS_HAS_ARGUMENT, /* flags */
    GWEN_ArgsType_Char,            /* type */
  ...
  rv=AFM_import_export_statements(ab, ctx, AE_Book_TableType_BankTransfer, queryString);
  if (rv<0) {
